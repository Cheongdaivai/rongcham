                        ...
                        <div className="h-full flex flex-col">
                          ...
                          <div className="mb-4">
                            <div className="flex items-start justify-between gap-4 mb-3">
                              <h3 className="text-2xl lg:text-3xl font-bold text-slate-900 leading-tight group-hover:text-blue-600 transition-colors duration-300">
                                {item.name}
                              </h3>
                            </div>
                          ...
                          <div className="grid grid-cols-3 gap-4 mb-6">
                            <div className="text-center p-3 bg-slate-50 rounded-xl">
                              <div className="text-lg font-bold text-slate-800">${item.price.toFixed(2)}</div>
                              <div className="text-xs text-slate-500 font-medium">Price</div>
                            </div>
                            <div className="text-center p-3 bg-green-50 rounded-xl">
                              <div className="text-lg font-bold text-green-600">{getMenuItemStats(item.menu_id).totalOrdered}</div>
                              <div className="text-xs text-slate-500 font-medium">Total Ordered</div>
                            </div>
                            <div className="text-center p-3 bg-blue-50 rounded-xl">
                              <div className="text-lg font-bold text-blue-600">${getMenuItemStats(item.menu_id).totalRevenue.toFixed(2)}</div>
                          ...
                          <div className="flex gap-3 mt-auto">
                            <Button className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl py-3 font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                              <Edit className="h-4 w-4 mr-2" />
                              Edit Item
                            </Button>
                            <Button className="flex-1 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-xl py-3 font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                              <Settings className="h-4 w-4 mr-2" />
                              {item.availability ? 'Disable' : 'Enable'}
                            </Button>
                            <Button className="px-4 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-xl py-3 font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
